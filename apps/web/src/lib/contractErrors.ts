...
// Error name to translation key mapping
export const ERROR_TRANSLATION_KEYS: Record<string, string> = {
  'AmountBelowMinimum': 'amountBelowMinimum',
  'AmountExceedsAvailable': 'amountExceedsAvailable',
  'WithdrawalExceedsAvailable': 'withdrawalExceedsAvailable',
  'AmountTooLarge': 'amountTooLarge',
  'OrderNotFound': 'orderNotFound',
  'TradeNotFound': 'tradeNotFound',
  'TradeNotPending': 'tradeNotPending',
  'TradeNotExpired': 'tradeNotExpired',
  'NotAuthorized': 'notAuthorized',
  'ProofVerificationFailed': 'proofVerificationFailed',
  'PaymentDetailsMismatch': 'paymentDetailsMismatch',
